...
rm -f ${TARGET_DIR}/usr/lib/python3.12/config-3.12-aarch64-linux-gnu/Makefile
...
rm -f ${TARGET_DIR}/usr/lib/python3.12/_sysconfigdata__linux_aarch64-linux-gnu.pyc
